...
let allSchools: [School] = [
    ...
    School(
        ...
        email: "CMS@edenpr.org",
        sheetTab: "CMS"
    ),

    School(
        name: "Cedar Ridge Elementary",
        email: "CedarRidge@edenpr.org",
        sheetTab: "Cedar Ridge"
    ),

    School(
        name: "Eagle Heights and Oak Point",
        email: "EagleHeights@edenpr.org",
        sheetTab: "Eagle Heights and Oak Point"
    ),

    School(
        name: "Eden Lake Elementary",
    ...
    School(
        ...
        email: "ForestHills@edenpr.org",
        sheetTab: "Forest Hills"
    ),

    School(
        name: "Prairie View and Little Eagles",
        email: "PrairieView@edenpr.org",
        sheetTab: "Prairie View and Little Eagles"
    ),

    School(
        name: "EP Online and TASSEL",
        email: "eponline@edenpr.org",
        sheetTab: "EP Online and TASSEL"
    )
]
...
class LanguageManager: ObservableObject {
    ...
    let translations: [String: [String: String]] = [
        "English": [
            ...
            "Sanitizing Wipes":                 "Sanitizing Wipes",
            "Hand Sanitizer":                   "Hand Sanitizer",
            "Towels":                           "Towels",
            "Paper Products":                   "Paper Products",
            "Dish Soap":                        "Dish Soap",
            "Granola Bars":                     "Granola Bars",
            "Mac n' Cheese Cups":               "Mac n' Cheese Cups",
        ...
        "Spanish": [
            ...
            "Backpacks":                        "Mochilas",
            "Folders":                          "Carpetas",
            "Pencil Pouch":                     "Estuche para lápices",
            "Colored Pencils":                  "Lápices de colores",
            "Markers":                          "Marcadores",
            "Notecards":                        "Tarjetas de notas",
            "Graphing Calculator":              "Calculadora gráfica",
            "Writing Utensils":                 "Útiles de escritura",
            "Erasers":                          "Borradores",
            "Soap":                             "Jabón",
            ...
            "Sandwich Bags":                    "Bolsas para sándwich",
            "Water Bottles":                    "Botellas de agua",
            "Sanitizing Wipes":                 "Toallitas desinfectantes",
            ...
            "Ramen Noodles":                    "Fideos ramen",
            "Fruit Cups":                       "Tazas de fruta",
            "Snack Items":                      "Artículos de merienda",
        ...
        "Somali": [
            ...
            "Clothing":             "Dharka",
            // Item names
            "Notebooks":                        "Buugaagta Qoraalka",
            "Backpacks":                        "Bac-dhabarka",
            "Folders":                          "Fayl-jilayaasha",
            "Pencil Pouch":                     "Kiisku Qalin",
            "Colored Pencils":                  "Qalinno Midabka leh",
            "Markers":                          "Markers",
            "Notecards":                        "Kaararka Xusuusnta",
            "Graphing Calculator":              "Kaalkuleytor Sawir-gacmeedka",
            "Writing Utensils":                 "Qalab Qorista",
            "Erasers":                          "Tirtirayaasha",
            "Soap":                             "Saabuun",
            "Brush/Comb":                       "Burush/Misho",
            "Shampoo for all hair types":       "Shampoo dhammaan noocyada timaha",
            "Body Spray":                       "Cafiis Jirka",
            "Deodorant":                        "Diodrant",
            "Feminine Care Products":           "Alaabta Daryeelka Dumarku",
            "Hair Ties":                        "Xidhayaasha Timaha",
            "Hair Pins":                        "Ibirrada Timaha",
            "Floss":                            "Xadhkaha Ilkaha",
            "Laundry Detergent":                "Sabuurada Dharka",
            "Garbage Bags":                     "Kiisaska Qashinka",
            "Sandwich Bags":                    "Kiisaska Sandwiishka",
            "Water Bottles":                    "Dhalooyinka Biyaha",
            "Sanitizing Wipes":                 "Tirtiraha Nadiifinta",
            "Hand Sanitizer":                   "Nadiifiyaha Gacmaha",
            "Towels":                           "Tuwaalayaasha",
            "Paper Products":                   "Alaabta Warqadda",
            "Dish Soap":                        "Saabuunta Saxanta",
            "Granola Bars":                     "Bararka Granola",
            "Mac n' Cheese Cups":               "Koobabka Baasta iyo Jiiska",
            "Juice Boxes":                      "Sanduuqyada Casiirta",
            "Ramen Noodles":                    "Noodles-ka Ramen",
            "Fruit Cups":                       "Koobabka Miraha",
            "Snack Items":                      "Cuntada Yaryar",
            "Non-Perishable Food Items":        "Cuntada aan Xumaan",
            "Take Home Meals/ Ingredients":     "Cuntada/Sheyga Guriga Loo Qaado",
            "Winter Clothing":                  "Dharka Jiilaalka",
            "Jackets":                          "Jaakadaha",
            "Boots":                            "Buudhadaha",
            "Hats":                             "Koofiyadaha",
            "Gloves":                           "Gacmo-gashiga",
            "Scarves":                          "Shaashada Qoorta",
            "Eden Prairie Apparel":             "Dharka Eden Prairie",
...
class InventoryViewModel: ObservableObject {
    ...
    func fetchInventory(for school: School) {
        ...
        let encodedTabName = school.sheetTab
            .replacingOccurrences(of: "+", with: "%2B")
            .addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? school.sheetTab

        let range = "'\(encodedTabName)'!A2:D100"
    ...
    var body: some View {
        VStack(spacing: 0) {
                    ...
                    VStack(spacing: 0) {
                        ForEach(allSchools) { school in
                            Button(action: {
                                ...
                                .background(
                                    selectedSchool.id == school.id
                                    ? Color(red: 0, green: 0.53, blue: 1).opacity(0.06)
                                    : Color.white
                                )
                            }
            ...
            if viewModel.isLoading {
                ...
                // Grouped inventory by category with translated headers
                ...
                .refreshable { viewModel.fetchInventory(for: selectedSchool) }
    ...
    var body: some View {
        NavigationStack {
            ZStack {
                ...
                // Admin Panel → opens admin panel directly
                NavigationLink(destination: AdminView(languageManager: languageManager)) {                    ZStack {
                ...
                // Family Login → inventory with school picker
